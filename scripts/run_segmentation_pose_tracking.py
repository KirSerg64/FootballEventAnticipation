...
Optional flags::
    ...
    --pose_backend       keypointrcnn     Pose backend: auto|keypointrcnn|bboxmaskpose|yolo
...
def _parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    ...
    parser.add_argument(
        "--pose_backend", default="keypointrcnn",
        choices=["auto", "keypointrcnn", "bboxmaskpose", "yolo"],
        help=(
            "Pose estimation backend (default: keypointrcnn).  "
