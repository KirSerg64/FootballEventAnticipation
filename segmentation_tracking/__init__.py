...
Modules:
    ...
    ball_kalman         -- Detection-first + MOSSE DCF ball tracker (BallDCFTracker); UKF retained for compat
...
from segmentation_tracking.ball_kalman import BallKalmanFilter, AdaptiveBallKalmanFilter, BallDCFTracker
